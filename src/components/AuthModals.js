                ...
                {authStep === 'selection' ? (
                    ...
                    <div className="grid gap-4 py-2">
                        ...
                        >
                            ...
                            <div className="h-14 w-14 rounded-full bg-slate-900 border border-slate-700/80 group-hover:border-amber-500/30 flex items-center justify-center mr-5 relative z-10 shadow-lg group-hover:shadow-amber-500/20 transition-all">
                                <Microscope className="text-slate-400 group-hover:text-amber-400 transition-colors" size={24} />
                            </div>

                            <div className="text-left flex-1 relative z-10">
                                <h3 className="text-lg font-bold text-slate-200 group-hover:text-white transition-colors">Researcher Portal</h3>
                                <p className="text-xs font-medium text-slate-500 group-hover:text-amber-500/80 transition-colors">Data & Model Access</p>
                            </div>
