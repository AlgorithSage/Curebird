                        ...
                        {chats.length === 0 ? (
                            ...
                            chats.map(chat => (
                                <motion.div
                                    ...
                                    className={`relative p-4 rounded-2xl border transition-all duration-300 cursor-pointer group hover:shadow-lg ${
                                ...
                                <div className="flex-1 overflow-y-auto px-4 sm:px-8 space-y-8 custom-scrollbar pb-6">
                                    {messages.map((msg, idx) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className={`max-w-[85%] sm:max-w-[65%] rounded-3xl p-5 relative group shadow-lg ${
                                                    isMe 
