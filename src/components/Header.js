...
const Header = ({ title, description, user, onAddClick, onShareClick, onLoginClick, onLogout, onToggleSidebar, onNavigate, alerts = [] }) => {
    ...
    return (
        ...
        <>
            <header className="sticky top-4 z-20 w-[98%] mx-auto rounded-[2rem] bg-slate-900/40 backdrop-blur-2xl border border-white/10 shadow-2xl flex flex-nowrap items-center justify-between px-4 py-3 sm:px-6 sm:py-4 transition-all duration-300">
