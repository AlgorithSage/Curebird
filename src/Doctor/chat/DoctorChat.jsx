                            ...
                            <AnimatePresence>
                                {showSlashMenu && (
                                    <motion.div
                                        ...
                                        className="absolute bottom-full left-0 mb-4 w-80 bg-stone-900/70 backdrop-blur-2xl border border-amber-500/20 rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.6),0_0_30px_rgba(245,158,11,0.15)] overflow-hidden z-50 flex flex-col bg-gradient-to-b from-amber-500/10 to-stone-950/80"
                                    >
                                        <div className="bg-gradient-to-r from-amber-500/15 to-transparent px-5 py-3 text-[11px] font-black text-amber-500 uppercase tracking-widest border-b border-amber-500/10 flex items-center gap-2">
