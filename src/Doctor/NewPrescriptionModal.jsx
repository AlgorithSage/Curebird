                        ...
                        <div className="px-8 py-6 border-b-2 border-amber-500/20 flex items-center justify-between bg-gradient-to-r from-amber-500/[0.07] via-transparent to-transparent relative z-10">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-slate-400 mt-1 uppercase tracking-wider font-medium">Clinical Order Initiation</p>
                                </div>
                            </div>
                            ...
                            <form id="prescription-form" onSubmit={handleSubmit} className="space-y-8">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <label className="text-[10px] uppercase font-bold text-slate-500 ml-1">Medications</label>
                                        <button
                                            type="button"
                                    ...
                                    <div className="space-y-6">
                                        {medications.map((med, idx) => (
                                            ...
                                            >
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    <div className="space-y-1">
                                                        <label className="text-[9px] uppercase font-bold text-slate-500 tracking-wider">Medicine Name</label>
                                                        <input
                                                            type="text"
                                                            placeholder="Metformin, Lisinopril..."
                                                            value={med.name}
                                                            onChange={(e) => updateMedication(idx, 'name', e.target.value)}
                                                            className="w-full p-2.5 border bg-black/30 border-amber-500/10 rounded-lg text-slate-200 focus:border-amber-500/50 focus:bg-black/50 outline-none transition-all placeholder:text-slate-600 sm:text-sm"
                                                        />
                                                    </div>
                                                    <div className="space-y-1">
                                                        <label className="text-[9px] uppercase font-bold text-slate-500 tracking-wider">Dosage</label>
                                                        <input
                                                            type="text"
