        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 sm:p-6 font-sans">
                ...
                <motion.div
                    ...
                    className="relative w-full max-w-2xl bg-[#1c1605] rounded-[2.5rem] overflow-hidden flex flex-col shadow-[0_0_100px_rgba(225,29,72,0.2),inset_0_0_120px_rgba(245,158,11,0.08)] border border-rose-500/30"
                >
